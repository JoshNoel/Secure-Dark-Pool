...
class ClientHandler(mp.Process):
    ...
    def _match_trade(self, client_pub_key, ciphers, cur_trades):
        return True
    ...
    def _post_pallier_keys(self, pall_keys):
        ...
        with self.pall_lock:
            for pub_key, pair in pall_keys.items():
                ...
                d = self.pall_dict[pub_key]
                d[self.client_pub_key] = pair
                self.pall_dict[pub_key] = d
    ...
    def __init__(self, server_name, client_id, pub_key, port, refresh_q, trades, num_clients, 
    ...
    def run(self):
        ...
        print("SERVER: listening for client " + str(self.client_id))
    ...
    def start_clients(self):
        ...
        for client_id, info in self.clients.items():
            ...
            proc = ClientHandler(self.server_name, client_id, 
                        ...
                        self.pall_key_lock, self.pall_keys)
            proc.start()
            proc.join()
