...
if __name__ == "__main__":
    ...
    client_3 = ctx.Process(name="pool_rpc_client3", target=run_client, args=('trades_1_1.json',), daemon=True)
    client_4 = ctx.Process(name="pool_rpc_client4", target=run_client, args=('trades_1_2.json',), daemon=True)
